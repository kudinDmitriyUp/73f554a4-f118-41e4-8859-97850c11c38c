...
export const metadata: Metadata = {
  title: "Joule Ventures | Israeli Founders, Enterprise Solutions",
  description: "High-conviction venture capital backing Israeli founders commercializing enterprise-grade solutions in U.S. markets. Day-one partners delivering top asset class returns.",
  keywords: "venture capital, Israeli startups, enterprise software, U.S. market entry, B2B tech investments",
  metadataBase: new URL("https://www.joulevc.com"),
  alternates: {
    canonical: "https://www.joulevc.com"
  },
  openGraph: {
    title: "Joule Ventures | High-Conviction Venture Capital",
    description: "First-check partners for Israeli founders commercializing enterprise-grade solutions in U.S. markets.",
    url: "https://www.joulevc.com",
    siteName: "Joule Ventures",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766006444080-y4a0id2m.jpg",
      alt: "Joule Ventures - High conviction investing"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Joule Ventures",
    description: "High-conviction investors backing Israeli founders in enterprise tech",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766006444080-y4a0id2m.jpg"]
  },
  robots: {
    index: true,
    follow: true
